...
public class Question implements Serializable{
	...
	public Question(Integer id, String category, String difficulty, String question, String correct_question,
	...
	public int hashCode() {
		...
		result = prime * result + ((correct_question == null) ? 0 : correct_question.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (category == null) {
			...
			return false;
		if (correct_question == null) {
			if (other.correct_question != null)
				return false;
		} else if (!correct_question.equals(other.correct_question))
			return false;
		if (difficulty == null) {
